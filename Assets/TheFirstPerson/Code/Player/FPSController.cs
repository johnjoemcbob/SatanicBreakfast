...
namespace TheFirstPerson
{
    ...
    public class FPSController : MonoBehaviour
    {
        ...
        public bool crouchJumpEnabled = false;
        ...
        void UpdateMovement(float dt)
        {
            if (dt > 0)
            {
                ...
                if (slide)
                {
                    ...
                    if (jumpEnabled && jumpWhileSliding && ( crouchJumpEnabled || !crouching ) )
                    {
                        if (jumpPressed > 0)
                        {
                ...
                if (grounded)
                {
                    ...
                    timeSinceGrounded = 0;
                    jumping = false;
                    if (jumpEnabled && (jumpWhileSliding || !slide) && ( crouchJumpEnabled || !crouching ) )
                    {
                        if (jumpPressed > 0)
                        {
                            Jump();
                ...
                else
                {
                    ...
                    if (jumpEnabled && timeSinceGrounded < coyoteTime && (jumpWhileSliding || !slide) && ( crouchJumpEnabled || !crouching ) )
                    {
